...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Write and preview GLSL fragment shaders in real-time with WebGL. Features animated examples including neon grids, starfields, aurora, fire effects, and more.',
    author: 'scott-peabody',
    date: '2026-01-27T12:00:00',
    tags: ['webgl', 'glsl', 'shaders', 'graphics', 'creative-coding'],
    communities: ['creative-coding', 'opensource'],
    techStack: ['WebGL', 'GLSL', 'React', 'TypeScript'],
    type: 'tool',
    status: 'completed',
    featured: true,
    concepts: ['3d-graphics', 'reactivity'],
    languages: ['typescript', 'javascript'],
    locations: ['github', 'the-web'],
  },
  {
    ...
    description: 'Create interactive graphics, animations, and simulations with p5.js. Includes examples of generative art, physics simulations, fractals, sorting algorithms, and more.',
    author: 'scott-peabody',
    date: '2026-01-28T12:00:00',
    tags: ['p5js', 'creative-coding', 'generative-art', 'physics', 'visualization'],
    communities: ['creative-coding', 'opensource', 'learners'],
    techStack: ['p5.js', 'React', 'TypeScript', 'CodeMirror'],
    type: 'tool',
    status: 'active',
    featured: true,
    concepts: ['game-development', 'reactivity'],
    languages: ['typescript', 'javascript'],
    locations: ['github', 'the-web'],
  },
  {
    slug: 'three-playground',
    title: 'Three.js Playground',
    description: 'Create stunning 3D animations and visualizations with Three.js and React Three Fiber. Features examples of infinite terrain, morphing geometry, particle galaxies, and more artistic 3D scenes.',
    author: 'scott-peabody',
    date: '2026-01-29T12:00:00',
    tags: ['threejs', '3d', 'webgl', 'creative-coding', 'animation'],
    communities: ['creative-coding', 'opensource', 'learners'],
    techStack: ['Three.js', 'React Three Fiber', 'React', 'TypeScript', 'CodeMirror'],
    type: 'tool',
    status: 'active',
    featured: true,
    concepts: ['3d-graphics', 'reactivity'],
